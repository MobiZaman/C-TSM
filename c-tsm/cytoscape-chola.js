...
var Layout = function () {
  ...
  _createClass(Layout, [{
    ...
    value: function run() {
      ...
      var coseLayout = layout.runCoseLayout(options, coseIdToLNode, this.cholaNodeToCoseNode, topMostNodes);
...
cholaLayout.prototype.runCoseLayout = function (options, idToLNode, cholaNodeToCoseNode, topMostNodes) {
...
cholaLayout.prototype.compactGraphHelper = function (gm, iel, axis, dir) {
...
cholaLayout.prototype.compactGraph = function (gm, maxPasses, iel) {
  /*
...
cholaLayout.prototype.reLocateBarMembers = function (gm, indexDict, dir, iel, axis) {
...
cholaLayout.prototype.assignNewLocsToBars = function (indexDict, dir, iel) {
  /*
   * if dir == 0, horizontal compaction is done towards right, vertical compaction is done towards bottom
